...
export default function MultiLevelRow({
  ...
  return (
    <div className={`${styles.mlRow} ${postStatus === 'error' ? styles.mlRowError : ''}`}>

      {/* ── Line 1: Status · Title · Description ── */}
      ...
      <div className={`${styles.line} ${styles.lineBorder}`}>
        ...
        {!isAuction ? (
          <div className={`${styles.field} ${styles.fieldNarrow} ${styles.fieldPrice}`}>
      ...
      {/* ── Line 3: Ship Policy · Method · Dims · Weight · Images · Remove ── */}
      <div className={`${styles.line} ${styles.lineBorder}`}>
        <div className={`${styles.field} ${styles.fieldWide}`}>
