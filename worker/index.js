...
// ── /ebay/price-lookup ────────────────────────────────────────────────────────
// eBay's sold-listings APIs are no longer freely available (Finding API shut
// down Jan 2025, Marketplace Insights requires program enrollment). We use the
// Browse API to return current active Buy It Now listings as a price reference,
// sorted by lowest price so the seller sees the competitive price floor.
